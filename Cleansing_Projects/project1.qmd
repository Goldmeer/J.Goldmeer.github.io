...
# Get the kaggle.json path from the environment variable
...
if kaggle_json_path and os.path.exists(kaggle_json_path):
    ...
    raise FileNotFoundError("kaggle.json not found or KAGGLE_JSON_PATH not set!")
...
# Define your dataset
dataset = "oleksiimartusiuk/e-commerce-data-shein"  # Example
...
if os.listdir(project_root):
    ...
    # Download dataset
    api.dataset_download_files(dataset, path=project_root, unzip=True)
    print("📥 Downloaded and extracted to:", project_root)
```
